...
REGION_CONFIG = {
    "CA": {
        ...
        "maintenance": {
            "Toyota": {"base_maint": 420, "escalation": 1.12},
            "Ford": {"base_maint": 950, "escalation": 1.2},
            "Honda": {"base_maint": 480, "escalation": 1.13},
            "Tesla": {"base_maint": 350, "escalation": 1.09},
            "BMW": {"base_maint": 1200, "escalation": 1.25},
        },
    },
    "NY": {
        "state": "NY",
        ...
        "maintenance": {
            "Toyota": {"base_maint": 450, "escalation": 1.13},
            "Ford": {"base_maint": 1000, "escalation": 1.22},
            "Honda": {"base_maint": 500, "escalation": 1.15},
            "Tesla": {"base_maint": 370, "escalation": 1.1},
            "BMW": {"base_maint": 1300, "escalation": 1.28},
        },
    },
    "TX": {
        "state": "TX",
        ...
        "maintenance": {
            "Toyota": {"base_maint": 390, "escalation": 1.1},
            "Ford": {"base_maint": 800, "escalation": 1.18},
            "Honda": {"base_maint": 420, "escalation": 1.12},
            "Tesla": {"base_maint": 340, "escalation": 1.08},
            "BMW": {"base_maint": 1100, "escalation": 1.22},
        },
    },
}
